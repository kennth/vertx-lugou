...
public class TruckServiceImpl implements TruckService {
	...
	private static final String	SQL_INSERT		= "INSERT INTO ttruck (licenseplate,truck_type,tonnage,volume_length,volume_width,volume_height) "
												+ "VALUES (?, ?, ?, ?, ?, ?)";
	private static final String	SQL_QUERY		= "SELECT * FROM ttruck WHERE id = ? limit 1";
	private static final String	SQL_QUERY_ALL	= "SELECT * FROM ttruck";
	private static final String	SQL_QUERY_COUNT	= "SELECT count(*) as count FROM ttruck";
	
	private static final String	SQL_UPDATE		= "UPDATE ttruck SET ";
	private static final String	SQL_DELETE		= "DELETE FROM `ttruck` WHERE id = ?";	

	public TruckServiceImpl(JsonObject config) {
		this(Vertx.vertx(), config);
	}

	public TruckServiceImpl(Vertx vertx, JsonObject config) {
		this.vertx = vertx;
		this.config = config;
	 ...
	 */
	/* (non-Javadoc)
	 * @see com.funmix.service.TruckServer#getAll(io.vertx.core.json.JsonObject)
	 */
	@Override
	 ...
	 */
	/* (non-Javadoc)
	 * @see com.funmix.service.TruckServer#getOne(java.lang.String)
	 */
	@Override
	 ...
	 */
	/* (non-Javadoc)
	 * @see com.funmix.service.TruckServer#insert(io.vertx.core.json.JsonObject)
	 */
	@Override
	 ...
	 */
	/* (non-Javadoc)
	 * @see com.funmix.service.TruckServer#update(io.vertx.core.json.JsonObject)
	 */
	@Override
	 ...
	 */
	/* (non-Javadoc)
	 * @see com.funmix.service.TruckServer#delete(java.lang.String)
	 */
	@Override
